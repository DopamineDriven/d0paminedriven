...
import { Tabs as BaseTabsPrimitive } from "@base-ui/react/tabs";
...
function BaseTabs({
  ...
  ...props
}: BaseTabsPrimitive.Root.Props) {
  return (
    <BaseTabsPrimitive.Root
      data-slot="tabs"
...
function BaseTabsList({
  ...
  variant = "default",
  ...props
}: BaseTabsPrimitive.List.Props & VariantProps<typeof tabsListVariants>) {
  return (
    <BaseTabsPrimitive.List
      data-slot="tabs-list"
...
function BaseTabsTrigger({ className, ...props }: BaseTabsPrimitive.Tab.Props) {
  return (
    <BaseTabsPrimitive.Tab
...
function BaseTabsContent({
  className,
  ...props
}: BaseTabsPrimitive.Panel.Props) {
  return (
    <BaseTabsPrimitive.Panel

...
import { Avatar as BaseAvatarPrimitive } from "@base-ui/react/avatar";

function BaseAvatar({
  className,
  size = "default",
  ...props
}: BaseAvatarPrimitive.Root.Props & {
  size?: "default" | "sm" | "lg";
}) {
  return (
    <BaseAvatarPrimitive.Root
      data-slot="avatar"
      data-size={size}
      className={cn(
...
function BaseAvatarImage({
  className,
  ...props
}: BaseAvatarPrimitive.Image.Props) {
  return (
    <BaseAvatarPrimitive.Image
...
function BaseAvatarFallback({
  className,
  ...props
}: BaseAvatarPrimitive.Fallback.Props) {
  return (
    <BaseAvatarPrimitive.Fallback

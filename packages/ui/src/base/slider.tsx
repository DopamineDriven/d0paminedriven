...
function BaseSlider({
  ...
  max = 100,
  ...props
}: BaseSliderPrimitive.Root.Props) {
  ...
  return (
    <BaseSliderPrimitive.Root
      ...
      thumbAlignment="edge"
      {...props}>
      <BaseSliderPrimitive.Control className="relative flex w-full touch-none items-center select-none data-disabled:opacity-50 data-vertical:h-full data-vertical:min-h-40 data-vertical:w-auto data-vertical:flex-col">

...
import { HeicExtractorWorkup } from "@/images/heic-workup.ts";

export class AvifExtractorWorkup extends HeicExtractorWorkup {
  ...
  /**
   *  ISOBMFF with ftyp avif/avis, dimensions in meta > iprp > ipco > ispe
   */
  protected isAvifSignature(buffer: Buffer<ArrayBufferLike>) {
